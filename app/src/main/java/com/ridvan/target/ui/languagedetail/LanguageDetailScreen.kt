...
fun LanguageDetailScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(language?.name.orEmpty(), maxLines = 1, overflow = TextOverflow.Ellipsis) },
                navigationIcon = {
                ...
                actions = {
                    ...
                    // Same Edit + ⋮ layout as CourseDetailScreen; Delete lives in the menu.
                    Box {
                        ...
                        DropdownMenu(expanded = menuExpanded, onDismissRequest = { menuExpanded = false }) {
                            DropdownMenuItem(
                                ...
                                text = { Text(stringResource(R.string.cd_delete_language), color = MaterialTheme.colorScheme.error) },
                                onClick = {
                                    menuExpanded = false
